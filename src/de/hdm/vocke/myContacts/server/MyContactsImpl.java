...
public class MyContactsImpl extends RemoteServiceServlet implements MyContacts{
	...
	/**
	 * Auslesen aller Kontakte, die den �bergebenen Nachnamen besitzen 
	 */
	@Override
	...
	/**
	 * Auslesen aller Kontakte, die den �bergebenen Vornamen besitzen 
	 */
	@Override
	...
	/** 
	 * l�schen eines Kontakt-Objektes
	 */
	@Override
...
//				ContactListContactMapper.findContactListContactByContactId(c.getId());
	...
	/*
	 * Methoden f�r Kontaktlisten-Objekte
	 */
	...
	/**
	 * ausgeben der Kontaktlsiten nach �bergebenem Name
	 */
	@Override
	...
	/**
	 * l�schen eines Kontaktlisten-Objektes 
	 */
	@Override
	...
	/*
	 * Methoden f�r ContactListContact-Objekte
	 */
	@Override
