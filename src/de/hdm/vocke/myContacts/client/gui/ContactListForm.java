...
//Formular f�r die Darstellung von selektierten Kontaktlisten 
...
public class ContactListForm extends VerticalPanel {
	...
	/*
	 * Die �nderung einer Kontaktliste bezieht sich auf den Titel 
	 * Die �nderung erfolgt direkt im Textfeld
	...
	private class SaveCallback implements AsyncCallback<Void> {
		@Override
		public void onFailure(Throwable caught) {
			Window.alert("Die Namens�nderung ist fehlgeschlagen!");
		}
	...
	/*
	 * Wenn die anzuzeigende Kontaktliste gesetzt bzw. gel�scht wird, werden die
	 * zugeh�renden Textfelder mit den Informationen aus dem KontaktlistenObjekt
